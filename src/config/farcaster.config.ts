...
export const developmentConfig: FarcasterConfig = {
  accountAssociation: {
    ...
    signature: "eLmEuihY57WPYkLtLOUsUItLXrYZ2/raJ73xXDskN3ZoIMS2H25H5z4oHetbOkJPqMxtrjdQ6DQ9ScsClaGajRw="
  },
  miniapp: {
    version: "1",
    name: "Emojify",
...
export const productionConfig: FarcasterConfig = {
  accountAssociation: {
    ...
    signature: "pugy8pCdprJ/+WMk4ahkj2D16eJXj8JuGqi3ipULhJcb5xGj8JgVbpMwzGELtJ7pBioqbmzNGLCBCkvWkfMU1hs="
  },
  miniapp: {
    version: "1",
    name: "Emojify",
